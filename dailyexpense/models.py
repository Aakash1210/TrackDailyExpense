...
class DailyExpense(models.Model):
    ...
    purpose=models.CharField(max_length=20,blank=False)
    ...
    category=models.ForeignKey(Category,null=True,blank=True,on_delete=models.CASCADE,related_name='category_expenses')
